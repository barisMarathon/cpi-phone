...
const DESKTOP_NOTIFICATIONS_BANNER: AlertBanner = {
    ...
    label: $t({
        defaultMessage:
            "CPI Phone needs your permission to enable desktop notifications for important messages.",
    }),
    buttons: [
        {
            variant: "solid",
...
const CONFIGURE_OUTGOING_MAIL_BANNER: AlertBanner = {
    ...
    label: $t({
        defaultMessage:
            "CPI Phone needs to send email to confirm users' addresses and send notifications.",
    }),
    buttons: [
        {
            variant: "subtle",
...
const INSECURE_DESKTOP_APP_BANNER: AlertBanner = {
    ...
    label: $t({
        defaultMessage:
            "CPI Phone Desktop is not updating automatically. Please upgrade for security updates and other improvements.",
    }),
    buttons: [
        {
            variant: "subtle",
...
const UNSUPPORTED_BROWSER_BANNER: AlertBanner = {
    ...
    label: $t({
        defaultMessage:
            "Because you're using an unsupported or very old browser, CPI Phone may not work as expected.",
    }),
    buttons: [
        {
            variant: "text",
...
const SERVER_NEEDS_UPGRADE_BANNER: AlertBanner = {
    ...
    intent: "danger",
    label: $t({
        defaultMessage: "This CPI Phone server is running an old version and should be upgraded.",
    }),
    buttons: [
        {
            variant: "subtle",
...
const time_zone_update_offer_banner = (): AlertBanner => {
    ...
    return {
        ...
        label: $t(
            {
                defaultMessage:
                    "Your computer's time zone differs from your CPI Phone profile. Update your time zone to {browser_time_zone}?",
            },
            {
                browser_time_zone,
            },
